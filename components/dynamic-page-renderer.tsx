...
export function DynamicPageRenderer({
  ...
  return (
    <div className={`dynamic-page-renderer ${compact ? 'compact' : 'full'}`}>
      ...
      {/* Footer in full view - Enhanced with better separation */}
      {!compact && (
        <div className="page-footer mt-12">
          ...
          >
            <div className="max-w-4xl mx-auto px-6">
              <p className="text-base font-medium mb-2" style={{ color: COLORS.white }}>
                Generated by{' '}
              ...
              <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
                Personalized insights for your beverage business
              </p>

              {/* Decorative divider */}
              <div className="mt-4 flex items-center justify-center gap-2">
                <div className="h-px w-12" style={{ backgroundColor: COLORS.cyan }}></div>
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: COLORS.cyan }}></div>
                <div className="h-px w-12" style={{ backgroundColor: COLORS.cyan }}></div>
              </div>

              <p className="text-xs mt-4" style={{ color: 'rgba(255, 255, 255, 0.5)' }}>
                Scroll up for more content or ask a new question
              </p>
            </div>
          </div>
        </div>
