...
export function DynamicForm({
  ...
  const renderField = (field: typeof formConfig.fields[0]) => {
    const commonClasses = "w-full px-4 py-3 bg-[#152238] border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:border-[#06B6D4] transition-colors";
