    ...
    <section className="min-h-screen w-full bg-[#0A1628] relative flex flex-col snap-start">
      ...
      <div className="min-h-[100px] px-12 pt-8 pb-6 flex items-center justify-between border-b border-white/10 relative z-10 flex-shrink-0">
        <div className="flex-1 max-w-[80%]">
          ...
          <p className="text-[#06B6D4] text-sm mt-1 truncate" title={subtitle}>
            {subtitle}
          </p>
        </div>
      ...
      <div className="flex-1 px-12 py-8 overflow-y-auto overflow-x-hidden" style={{ maxHeight: 'calc(100vh - 220px)' }}>
        <div className="max-w-7xl mx-auto grid grid-cols-2 gap-8 min-h-0">
          ...
          <div className="flex flex-col justify-between h-full min-h-0">
            ...
            <div className="grid grid-cols-3 gap-4 flex-shrink-0">
              {stats.slice(0, 3).map((stat, idx) => (
                ...
                >
                  <div className="text-3xl font-bold text-[#06B6D4] mb-1 truncate" title={stat.value}>{stat.value}</div>
          ...
          <div className="flex flex-col justify-between h-full gap-4 min-h-0">
            ...
            <div className="bg-gradient-to-br from-[#06B6D4]/10 to-transparent p-8 rounded-xl border border-[#06B6D4]/20 flex-1 overflow-y-auto min-h-0">
